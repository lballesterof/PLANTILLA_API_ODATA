...
namespace PLANTILLA_API_ODATA.Reports.Precuenta
{
    public class TicketPDF
    {
        ...
        ArrayList headerLines1 = new ArrayList();
        ...
        static Rectangle pgSize = new Rectangle(216, 216);
        Document myDocument = new Document(pgSize); //Aqui se ponen todos los objetos
        ...
        public void AddHeaderLine1(string line)
        {
            headerLines1.Add(line);
        }
        ...
        private void DrawHeaderMaster()
        {
            try
            {
                foreach (string header in headerLines1)
                {
