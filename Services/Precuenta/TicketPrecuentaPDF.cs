...
{
    public class TicketPrecuentaPDF
    {
        public class TicketPDF
        {
            ...
            public Document myDocument = new Document(PageSize.LETTER); //Aqui se ponen todos los objetos
            ...
            public byte[] Report()
            {
                this.myDocument = new Document(PageSize.A4, 10f, 10f, 20f, 30f);

                myDocument.AddAuthor("Unosoft Systems");
                myDocument.AddCreator("Unosoft Restaurante");
                myDocument.AddTitle("Restaurante Mobile");
               
                PdfWriter.GetInstance(myDocument, _memoryStream);
                ...
                this.AddHeaderLine("TICKET_HEADER_01");
                this.AddHeaderLine("TICKET_HEADER_02");
                this.AddHeaderLine("TICKET_HEADER_03");
                this.AddHeaderLine("TICKET_HEADER_04");
                this.AddHeaderLine("TICKET_HEADER_05");

                this.AddSubHeaderLine("Dato 1");
                this.AddSubHeaderLine("Dato 2");
                this.AddSubHeaderLine("Dato 3");
                this.AddSubHeaderLine("Dato 4");
                this.AddSubHeaderLine("Dato 5");

                int Cantidad = 1;
                string Producto = "Stacarbone 100";
                int Total = 1500;
                // Detalles
                this.AddItem(Cantidad.ToString(), Producto.Substring(0, 11), Total.ToString());
                return Print();
            }
            ...
            public byte[] Print()
            {
                try
                {
                    ...
                    writer = PdfWriter.GetInstance(myDocument, _memoryStream);
                    myDocument.Open();
